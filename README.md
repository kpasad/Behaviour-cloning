...
* This happens because the training data is imbalanced with much larger proportion of images correponding to a sterring angle of zero. See the following PDF and CDF of steering angle for one lap around the track ![PDF of imbalanced data set](/images/pdf) ![CDF of imbalanced data set](/images/histo.png) 
