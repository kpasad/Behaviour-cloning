...
* It can be concluded that the network depends on the few impactful training samples. 
* No correlation was found between the MSE and ability to drive. This again can be explained by
