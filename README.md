...
* The network was retrained after each additional data. Figure below shows the CDF of combined drive ![CDF of combined drives data ](/images/cfd_successive_additions.png) . It also intresting to see how the CDF of drives changes as the downsampling factor is changed.![CDF of individual drives with diffrent downsampling ](/images/cdf_drives_ds.png)
